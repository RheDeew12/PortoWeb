...
@section('konten')
    ...
    <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
        <div class="card-body p-4 p-md-5">
            <div class="mb-4">
                <h4 class="fw-bold text-dark mb-1">Tambah Portofolio Proyek</h4>
                <p class="text-muted small">Silakan isi formulir di bawah ini untuk menambahkan daftar karya atau proyek baru Anda.</p>
            </div>
            ...
            <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        accept="image/*"
                    />
                    <div class="form-text text-muted" style="font-size: 11px;">Format berkas yang didukung: JPG, JPEG, PNG. Maksimal ukuran berkas 2MB.</div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea 
                        ...
                        id="description" 
                        rows="8" 
                        placeholder="Tuliskan latar belakang pembuatan proyek, fitur-fitur utama sistem, atau peran Anda dalam pengembangan proyek ini...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="pt-2 d-flex justify-content-end gap-2">
                    <button class="btn btn-primary rounded-pill px-4 fw-semibold d-inline-flex align-items-center gap-2 shadow-sm" type="submit">
                        <i class="mdi mdi-content-save-outline"></i> SIMPAN PROYEK
                    </button>
                </div>
            </form>
        </div>
