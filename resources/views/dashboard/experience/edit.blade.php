...
@section('konten')
    ...
    <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
        <div class="card-body p-4 p-md-5">
            <div class="mb-4">
                <h4 class="fw-bold text-dark mb-1">Edit Pengalaman Kerja</h4>
                <p class="text-muted small">Silakan perbarui formulir di bawah ini untuk mengubah riwayat pengalaman profesional Anda.</p>
            </div>
